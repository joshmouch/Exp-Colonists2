...
class UI {
    ...
    setupEventListeners() {
        ...
        // Game speed slider
        this.speedSlider.min = GAME_CONSTANTS.GAME_SPEED.MIN;
        this.speedSlider.max = GAME_CONSTANTS.GAME_SPEED.MAX;
        this.speedSlider.step = GAME_CONSTANTS.GAME_SPEED.STEP;
        this.speedSlider.value = GAME_CONSTANTS.GAME_SPEED.DEFAULT;
        this.speedValue.textContent = GAME_CONSTANTS.GAME_SPEED.DEFAULT + 'x';

        this.speedSlider.addEventListener('input', () => {
            const speed = parseFloat(this.speedSlider.value);
            this.game.setGameSpeed(speed);
            this.speedValue.textContent = speed.toFixed(0) + 'x';
        });
